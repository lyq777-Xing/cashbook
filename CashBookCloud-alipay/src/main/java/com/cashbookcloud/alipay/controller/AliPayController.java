...
public class AliPayController {
    ...
    public ResponseResult alipay(@RequestBody AliPayBean aliPayBean) throws AlipayApiException {
        ...
        alipayRequest.setReturnUrl("http://localhost:8080/#/test");
    ...
    public ResponseResult paycheck(@RequestBody AliPayCheckBean aliPayCheckBean) throws AlipayApiException {
        ResponseResult<Object> result=new ResponseResult<>();
        try{
